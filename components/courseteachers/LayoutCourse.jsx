        ...
        <div className=" flex flex-row h-full ">
          ...
          >
            ...
            <Link href={`/course`}>
              <a
                className={` flex items-center gap-2 py-2.5 px-4 rounded transition duration-200 hover:bg-gray-200 hover:text-gray-800 ${
                  router.asPath === `/course` ? "bg-gray-200" : ""
                }`}
              >
            ...
            <Link href={`/course/manage`}>
              <a
                className={` flex items-center text-lg gap-2 py-2.5 px-4 rounded transition duration-200 hover:bg-gray-200 hover:text-gray-800 ${
                  router.asPath === `/course/manage`
                    ? "bg-gray-200"
                    : ""
                }`}
              >
               <ListAltIcon/> การจัดการโครงงาน
              </a>
            </Link>
            <Link href={`/course/notification`}>
              <a
                className={` flex items-center gap-2 py-2.5 px-4 rounded transition duration-200 hover:bg-gray-200 hover:text-gray-800 ${
                  router.asPath === `/course/notification`
                    ? "bg-gray-200"
                    : ""
                }`}
              >
                <NotificationsActiveIcon className="text-yellow-500"   /> การแจ้งแตือน
              </a>
            </Link>
            <Link href={`/course/history`}>
              <a
                className={` flex items-center gap-2 py-2.5 px-4 rounded transition duration-200 hover:bg-gray-200 hover:text-gray-800 ${
                  router.asPath === `/course/history`
                    ? "bg-gray-200"
                    : ""
                }`}
              >
                <PersonIcon />   ประวัตินิสิต
              </a>
            </Link>
