...
export default function courseLayout({children,title}) {
      ...
      <div className="h-screen w-screen  flex flex-col ">
        ...
        >
          ...
          <div className="flex space-x-5">
            ...
            <div onClick={()=>setEdit(!edit)} className={ !edit ? "rounded-full bg-gray-200 w-10 h-10 items-center flex justify-center relative   " :" rounded-full bg-red-200 w-10 h-10 items-center flex justify-center relative text-red-500"}>
