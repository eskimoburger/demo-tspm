  ...
  return (
    <div>
      <div className="p-5 bg-white rounded-lg  shadow-lg  ">
        <h3 className="text-3xl mb-2">เพิ่มรายชื่อนักเรียน</h3>
        <br />
        ...
        />
        <h2 className="text-xl my-2 text-red-500 ">* กรุณาเลือกไฟล์ .csv</h2>
        <br />
        {students.length != 0 && (
          <button
            className="bg-green-500 text-xl text-white p-2 rounded-md hover:bg-green-600"
