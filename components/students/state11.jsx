...
export default function state11(props) {
  useEffect(() => {
    //getTeachers();
    getTeacherByIdProjectStage10(props.project.idP);
  }, []);
  ...
  return (
    ...
    >
      ...
      <button onClick={()=>{sendFinalExamResult()}}>TEST DATA</button>
      {/* <br />
      <div className="px-10">
          ...
          {teachers.map((teacher, index) => {
            return (
              <div key={index} className="mb-4">
                ...
                {teacher.exam_detail.length > 0 ?<div>
