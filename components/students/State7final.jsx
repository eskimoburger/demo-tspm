...
export default function state7({
  ...
  const finalSendAsses = async () => {
    await axios
      .post("https://demo-tspm-server.herokuapp.com/final-project/state-6-asses/" + projectId, {
        project_eng: projectNameENG,
        project_th: projectNameTH,
      ...
      >
        ...
        >
          <div className="stage2:text-left text-base  stage2:w-[500px] stage2:text-2xl space-y-2    ">
            ...
            <p>
              {" "}
              <span className="font-bold"> ชื่อโครงงาน (ภาษาอังกฤษ) :</span> {projectNameENG}
            </p>
