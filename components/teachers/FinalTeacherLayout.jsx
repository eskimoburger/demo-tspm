...
export default function FinalTeacherLayout({ children, title }) {
        ...
        <div className=" flex flex-row h-full ">
          ...
          >
            <Link href={`/teacher/${id}`}>
              <a
                className={` flex items-center gap-2 py-2.5 px-4 rounded transition duration-200 hover:bg-gray-200 hover:text-gray-800 ${
                  router.asPath === `/teacher/${id}` ? "bg-gray-200" : ""
                }`}
              >
            ...
            <Link href={`/teacher/${id}/manage`}>
              <a
                className={` flex items-center gap-2 py-2.5 px-4 rounded transition duration-200 hover:bg-gray-200 hover:text-gray-800 ${
                  router.asPath === `/teacher/${id}/manage` ? "bg-gray-200" : ""
                }`}
              >
                <ListAltIcon /> รายชื่อโครงงาน
              </a>
            </Link>
            <Link href={`/teacher/${id}/notification`}>
              <a
                className={` flex items-center gap-2 py-2.5 px-4 rounded transition duration-200 hover:bg-gray-200 hover:text-gray-800 ${
                  router.asPath === `/teacher/${id}/notification` ? "bg-gray-200" : ""
                }`}
              >
            ...
            <Link href={`/teacher/${id}/history`}>
              <a
                className={` flex items-center gap-2 py-2.5 px-4 rounded transition duration-200 hover:bg-gray-200 hover:text-gray-800 ${
                  router.asPath === `/teacher/${id}/history` ? "bg-gray-200" : ""
                }`}
              >
